...
(function(root) {
  var Mimosas = function() {
    ...
    require['./model_subject'] = (function() {
      ...
      // Generated by CoffeeScript 1.6.3
      var Iterator, List, ModelSubject;
      ...
      ModelSubject = (function() {
        ...
        ModelSubject.prototype.notify = function(aspect) {
          var currentItem, i, _results;
    ...
    require['./view_component'] = (function() {
      ...
      ViewComponent = (function(_super) {
        ...
        function ViewComponent(element) {
          ...
          this.setController(this.defaultControllerClass);
        }
    ...
    require['./view_composite'] = (function() {
      ...
      ViewComposite = (function(_super) {
        ...
        ViewComposite.prototype.addSubView = function() {
        ...
        ViewComposite.prototype.displayView = function() {};
